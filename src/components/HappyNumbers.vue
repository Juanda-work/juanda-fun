        ...
        <v-container>
            ...
            <v-row>
                ...
                <v-col cols="3" class="finalMessage">
                    <div> 
                        <v-fab-transition v-if="isHappy"> 
                            <v-alert v-if="showHappyMsg()" type="success"> El número es feliz </v-alert> 
                        </v-fab-transition> 
                        <v-fade-transition v-if="!isHappy"> 
                            <v-alert v-if="showUnhappyMsg()" type="error"> No es feliz... </v-alert> 
                        </v-fade-transition> 
                    </div>
                </v-col>
